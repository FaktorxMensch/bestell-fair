<template>
  <div style=""
       class="inset-0 absolute z-0"></div>
  <v-main
      class="min-h-screen"
      style="background: url('/partner/texture.jpg') no-repeat center center fixed; background-size: cover; ">
    <div class="bg-white border shadow-lg rounded my-12 rounded-xl overflow-hidden max-w-3xl mx-auto">
      <!--      <v-img src="/landing/demo.webp"/>-->
      <div class="space-y-3 p-10 ">
          ...
          <v-card variant="outlined" class="mt-6">
            ...
            <v-list class="divide-y">
              <v-list-item>
                ...
                <p>
                  Das
                  <a :href="'/restaurant/' + demo.newRestaurant.id" target="_blank"
        ...
        <v-card variant="tonal" rounded="lg" color="primary" class="mt-10">
          <v-card-title>
            <div class="flex">
